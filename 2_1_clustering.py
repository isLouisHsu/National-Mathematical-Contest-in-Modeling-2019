...
plt.grid()
plt.savefig("images/2_1_pca.png")
plt.show()
...
plt.ylabel("Score")
plt.grid()
plt.savefig("images/2_1_kmeans.png")
plt.show()
...
np.savetxt("output/2_1_seqLabels_pca%d_kmeans%d.txt" % (n_components, n_clusters), y.astype(np.int))
joblib.dump(pipline, "output/2_1_model_pca%d_kmeans%d.pkl" % (n_components, n_clusters))
...
np.savetxt("output/2_1_pca_explained_variance_.txt", pipline.named_steps.pca.explained_variance_)
np.savetxt("output/2_1_pca__components_.txt", components_)
np.savetxt("output/2_1_pca__mean_.txt", mean_)
np.savetxt("output/2_1_kmeans__cluster_centers_.txt", cluster_centers_)
np.savetxt("output/2_1_kmeans__cluster_centers_inv.txt", clusterCenters)
